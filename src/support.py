...
class GuiCmdType:
    ...
    color: str = 'color'
    display: str = 'display'
    grids_restore: str = 'grids_restore'
    grids_save: str = 'grids_save'
    lift: str = 'lift'
    restore: str = 'restore'
    save: str = 'save'
    wait: str = 'wait'
...
def grid_index_from_name(name):
    return GRID_NAMES.index(name)
...
def is_solved():
    ...
    try:
        for grid_index in range(4):
            if board.board_list[grid_index][1] != MAX_CELLS:
                return False
        return True
